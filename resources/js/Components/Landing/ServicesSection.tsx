...
import { Rocket, Building2, GraduationCap, Zap, BarChart3, Shield, Globe, CreditCard, LineChart, type LucideIcon } from 'lucide-react';
        ...
        <section className="relative min-h-screen w-full overflow-hidden bg-background py-24 sm:py-32">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <h2 className="mb-6 text-3xl font-bold uppercase tracking-tight text-foreground sm:text-4xl md:text-5xl lg:text-6xl">
                        What We <span className="text-gradient">Deliver</span>
                    </h2>
                    <p className="mx-auto max-w-2xl font-mono text-sm text-muted-foreground sm:text-base">
                        Three core offerings. Infinite possibilities. Each solution engineered
                        for maximum impact and scalability.
                    </p>
                </motion.div>
                ...
                >
                    {services.map((service, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className="relative h-full overflow-hidden rounded-2xl border border-border/50 bg-card/50 p-6 transition-all duration-500 glass hover:border-primary/50 hover:glow-sm sm:p-8">
                                    ...
                                    <div className="relative z-10">
                                        {/* Icon */}
                                        <div className="mb-6 inline-flex rounded-xl border border-border/50 bg-background/50 p-3 transition-all duration-300 group-hover:border-primary/50 group-hover:glow-sm">
                                            <Icon className={`${isLarge ? 'h-8 w-8' : 'h-6 w-6'} text-primary`} />
                                        </div>
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <h3 className={`font-bold uppercase tracking-tight text-foreground ${isLarge ? 'text-2xl sm:text-3xl' : 'text-xl sm:text-2xl'}`}>
                                                {service.title}
                                            </h3>
                                        </div>

                                        {/* Description */}
                                        <p className={`mb-6 font-mono text-muted-foreground ${isLarge ? 'text-sm sm:text-base' : 'text-xs sm:text-sm'}`}>
                                            {service.description}
                                        </p>
                    ...
                    >
                        <div className="group relative h-full overflow-hidden rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/10 via-background to-accent/10 p-6 transition-all duration-500 hover:border-primary/50 hover:glow-sm sm:p-8">
                            <div className="flex h-full flex-col items-center justify-center text-center">
                                <span className="mb-2 font-mono text-xs uppercase tracking-widest text-primary">
                                    Ready to start?
                                </span>
                                <h3 className="mb-4 text-xl font-bold uppercase tracking-tight text-foreground sm:text-2xl">
                                    Let's Build Something <span className="text-gradient">Extraordinary</span>
                                </h3>
                                <button className="inline-flex items-center gap-2 rounded-full border border-primary bg-primary/10 px-6 py-3 font-mono text-sm uppercase tracking-wider text-primary transition-all duration-300 hover:bg-primary hover:text-primary-foreground">
                                    Get Started
